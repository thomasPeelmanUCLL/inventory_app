                            ...
                            return (
                                <React.Fragment key={topItem.itemId}>
                                    <tr
                                        ...
                                        onClick={() => toggleItemExpanded(topItem.itemId)}
                                    >
                                        ...
                                        <tr className="bg-gray-50">
                                            <td colSpan={4} className="px-4 py-2">
                                                <div className="ml-8 space-y-2">
                                                    ...
                                                    {topItem.priceBreakdown.map(
                                                        (priceBreakdownEntry, entryIndex) => (
                                                            <div
                                                                key={entryIndex}
                                                            ...
                                                            >
                                                                ...
                                                                <div className="text-right">
                                                                    <div className="font-bold text-green-700">
                                                                        €
                                                                        {asMoney(
                                                                            priceBreakdownEntry.profit,
                                                                        )}
                                                                    </div>
                                                                    <div className="text-xs text-gray-500">
                                                                        €
                                                                        {asMoney(
                                                                            priceBreakdownEntry.totalSell,
                                                                        )}{' '}
                                                                        - €
                                                                        {asMoney(
                                                                            priceBreakdownEntry.totalBuy,
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            </div>
