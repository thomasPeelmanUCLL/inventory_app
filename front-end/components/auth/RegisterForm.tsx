...
const RegisterForm: React.FC<RegisterFormProps> = ({ onRegisterSuccess }) => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMessage(registrationError.message || 'Failed to create user. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" value={registrationForm.email} onChange={handleChange}
