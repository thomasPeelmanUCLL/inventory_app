...
export default function PriceVariablesSection({ itemId, canEdit }: PriceVariablesSectionProps) {
    ...
    const [priceVariableBeingEdited, setPriceVariableBeingEdited] = useState<PriceVariable | null>(
        null,
    );
                ...
                <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <input
                            ...
                            onChange={(e) =>
                                setNewPriceVariableForm({
                                    ...newPriceVariableForm,
                                    name: e.target.value,
                                })
                            }
                        ...
                        <label className="flex items-center gap-2">
                            <input
                                type="checkbox"
                                checked={newPriceVariableForm.isDefault}
                                onChange={(e) =>
                                    setNewPriceVariableForm({
                                        ...newPriceVariableForm,
                        ...
                        >
                            {priceVariableBeingEdited?.id === priceVariable.id ? (
                                <div className="grid grid-cols-4 gap-2">
                                    <input
                                        type="text"
                                        value={priceVariableBeingEdited.name}
                                        onChange={(e) =>
                                            setPriceVariableBeingEdited({
                                                ...priceVariableBeingEdited,
                                                name: e.target.value,
                                            })
                                        }
                                    ...
                                    />
                                    <select
                                        value={priceVariableBeingEdited.type}
                                        onChange={(e) =>
                                            setPriceVariableBeingEdited({
                                                ...priceVariableBeingEdited,
                                                type: e.target.value as 'PERCENTAGE' | 'FIXED',
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            onClick={() => setPriceVariableBeingEdited(null)}
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex gap-4">
                                        ...
                                        <span className="text-blue-600">
                                            {priceVariable.type === 'PERCENTAGE'
                                                ? `${priceVariable.value}%`
                                                : `€${priceVariable.value.toFixed(2)}`}
                                        </span>
                                    ...
                                    {canEdit && priceVariable.id && (
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                onClick={() =>
                                                    setDeleteConfirmId(priceVariable.id!)
                                                }
