...
export default function EditInventory() {
  ...
  useEffect(() => {
    // Fetch inventory data when the component mounts and id is available
    if (id) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await InventoryService.updateInventory(Number(id), {
        name,
        description
      });

      // Redirect to inventory list page after successful update
